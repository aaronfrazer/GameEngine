...
/**
 * The frame buffer for the shadow pass. This class is responsible for setting
 * up the depth texture which can be rendered to during the shadow render pass,
...
public class ShadowFrameBuffer
{
     ...
     * @param width width of the shadow map in pixels
     * @param height height of the shadow map in pixels
     */
    ...
    /**
     * Returns the ID of the shadow map texture.
     ...
     * @return newly created frame buffer's ID.
     */
