...
// NOTE: near/far variables must be the same as in MasterRenderer.java (NEAR_PLANE/FAR_PLANE)
uniform float near = 0.1;
uniform float far = 1000.0;

const float waveStrength = 0.04; // distortion factor
const float shineDamper = 20.0; // shineness of light
const float reflectivity = 0.5; // reflectivity
...
void main(void) {
    ...
    out_Color.a = clamp(waterDepth / 5.0, 0.0, 1.0); // water depth value (5)
