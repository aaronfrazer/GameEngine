...
/**
 * A class responsible for parsing an OBJ file.
 *
 * @author Aaron Frazer
 */
public class OBJFileLoader
{
	 ...
	 * @return data - data about the model (vertices, texture coords, normals, indices)
	 */
	public static RawModel loadOBJModel(String objFileName, Loader loader)
	{
		...
		try {
			...
			System.err.println("File not found: " + RES_LOC + objFileName + ".obj");
		}
